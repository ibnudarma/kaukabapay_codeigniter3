...
--
-- Host: localhost:3306
-- Generation Time: May 12, 2025 at 07:44 PM
...
-- Database: `kaukabapay`
--
CREATE DATABASE IF NOT EXISTS `kaukabapay` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `kaukabapay`;
...
('root', '[{\"db\":\"kaukabapay\",\"table\":\"users\"},{\"db\":\"kaukabapay\",\"table\":\"pegawai\"},{\"db\":\"kaukabapay\",\"table\":\"pembayaran\"},{\"db\":\"kaukabapay\",\"table\":\"pengeluaran\"},{\"db\":\"kaukabapay\",\"table\":\"siswa\"},{\"db\":\"kaukabapay\",\"table\":\"tagihan\"},{\"db\":\"mysql\",\"table\":\"time_zone_name\"}]');
...
('root', '2025-05-12 19:42:58', '{\"Console\\/Mode\":\"collapse\"}');
